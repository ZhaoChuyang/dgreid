...
from ..utils.tools import read_json, mkdir_if_missing, write_json
...
class CUHK03(BaseImageDataset):
    ...
    def __init__(self, root='datasets', combineall=False, verbose=True,
                 split_id=0, cuhk03_labeled=True, cuhk03_classic_split=False, **kwargs):
