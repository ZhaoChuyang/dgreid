...
from reid.trainers import MoCoTrainer
from reid.evaluators import Evaluator, extract_features
from reid.utils.data import CommDataset
from reid.utils.data import IterLoader
from reid.utils.data import transforms as T
from reid.utils.data.sampler import RandomMultipleGallerySampler
from reid.utils.data.preprocessor import MoCoProcessor, Preprocessor
...
def main_worker(args):
    ...
    model.module.initialize_queue(train_loader_source)
    ...
    # Trainer
    trainer = MoCoTrainer(model, args.nclass, margin=args.margin)
