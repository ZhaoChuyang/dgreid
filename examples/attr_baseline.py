...
from reid.trainers import Baseline_Trainer, IDM_Trainer, Base_Trainer, AttrTrainer
from reid.evaluators import Evaluator, extract_features
from reid.utils.data import CommDataset, AttrDataset
from reid.utils.data import IterLoader
from reid.utils.data import transforms as T
from reid.utils.data.sampler import RandomMultipleGallerySampler
from reid.utils.data.preprocessor import Preprocessor, AttrPreprocessor
...
def get_train_loader(args, dataset, height, width, batch_size, workers,
    ...
    preprocessor = AttrPreprocessor(train_set, root=dataset.images_dir, transform=train_transformer)
...
def main_worker(args):
    ...
    dataset_source = AttrDataset(train_items)
    ...
    # Trainer
    trainer = AttrTrainer(model, args.nclass, margin=args.margin, lam=args.lam)
