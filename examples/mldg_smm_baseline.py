...
from reid.trainers import MLDGSMMTrainer1
...
def main_worker(args):
    ...
    # Trainer
    trainer = MLDGSMMTrainer1(model, args.nclass, margin=args.margin, mldg_beta=args.mldg_beta, num_domains=num_domains)
